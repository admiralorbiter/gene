"""Prompt templates and formatting for Stage 8C-R3 (CONTRACT-R8-8C-R3)."""

from typing import Any, Dict, List


STAGE8C_R3_SYSTEM_PROMPT = """You are an epistemic entity resolution and ontology management assistant.
