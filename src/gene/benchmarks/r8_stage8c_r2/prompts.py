"""Prompt templates and system prompt for Stage 8C-R2:
Two-Stage Epistemic Ingress: Existence vs Identity Decoupling,
Grounded Structural Partitions, and Nullable Hypothesis Candidates.
"""

STAGE8C_R2_SYSTEM_PROMPT = """You are an autonomous epistemic entity resolution and registry mutation engine.
