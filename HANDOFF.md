...
- **Stage 8C-R1**: Non-Durable Hypothesis Ledger (`SUPERSEDED` / `REVISED_CONTRACT_REQUIRED` at commit `f7e178b`). Rescored audit: Gate 2a PASS ($0/120$ canonical false merges), Gate 3 PASS (0 duplicates), Useful Resolvable Coverage $78.4\%$.
...
- **Key Epistemic Hardening**:
  ...
  5. Explicit Claim Ceiling and V0 Executable Sealing Gate (`SEALING_MANIFEST-R8-8C-R2.json`).
...
- **Verified Commit**: `df914229b0f4fa9bdf01691a5be0cce434c06b24`
